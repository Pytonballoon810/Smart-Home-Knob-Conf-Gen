...
function App() {
  ...
  const calculateWidthRadians = (item: any): number => {
  ...
  const copyConfigToClipboard = () => {
    ...
    navigator.clipboard
      ...
      .then(() => {
        setNotification({
          visible: true,
          message: "Compact configuration copied to clipboard!",
        });
      })
      .catch((err) => {
              ...
              <ConfigItem
                ...
                dragHandleProps={{
                  onMouseDown: (e: React.MouseEvent) => {
                    e.preventDefault();
                    const dragElement =
                      e.currentTarget.closest(".draggable-item");
                    ...
                    const itemHeight =
                      dragElement.getBoundingClientRect().height;
